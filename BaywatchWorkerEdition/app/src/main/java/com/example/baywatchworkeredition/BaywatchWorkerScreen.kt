...
import com.example.baywatchworkeredition.R

import com.example.baywatchworkeredition.workerScreens.AddStatusScreen
import com.example.baywatchworkeredition.workerScreens.HomeScreen
...
fun BaywatchWorkerScreen(
    ...
    Scaffold(
        ...
        NavHost(
            ...
            startDestination = BaywatchWorkerScreen.Home.name,
